"""
Django settings for yellow_field_dev_133176 project.
...
ROOT_URLCONF = 'yellow_field_dev_133176.urls'
...
WSGI_APPLICATION = 'yellow_field_dev_133176.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_field_dev_133176 API",
    "DESCRIPTION": "API documentation for yellow_field_dev_133176 App",
    "VERSION": "v1",
}
